...
class Sql2oCandidateRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        ...
        var candidate = sql2oCandidateRepository.save(new Candidate(0, "name", creationDate, "description", true, 1, file.getId()));
    ...
    public void whenSaveSeveralThenGetAll() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate1 = sql2oCandidateRepository.save(new Candidate(0, "name", creationDate, "description", true, 1, file.getId()));
        var candidate2 = sql2oCandidateRepository.save(new Candidate(0, "name1", creationDate, "description", true, 3, file.getId()));
        var candidate3 = sql2oCandidateRepository.save(new Candidate(0, "name2", creationDate, "description", true, 4, file.getId()));
    ...
    public void whenUpdateThenGetUpdated() {
        ...
        var updatedCandidate = new Candidate(
                candidate.getId(), "new name", creationDate.plusDays(1), "new description",
    ...
    public void whenUpdateUnExistingVacancyThenGetFalse() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate = new Candidate(0, "name", creationDate, "description", true, 1, file.getId());
