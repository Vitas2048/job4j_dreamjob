...
public class Sql2oVacancyRepositoryTest {
    ...
    public void whenSaveSeveralThenGetAll() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var vacancy1 = sql2oVacancyRepository.save(new Vacancy(0, "title1", creationDate, "description", true, 1, file.getId()));
        var vacancy2 = sql2oVacancyRepository.save(new Vacancy(0, "title2",  creationDate, "description", false, 1, file.getId()));
        var vacancy3 = sql2oVacancyRepository.save(new Vacancy(0, "title3",  creationDate, "description", true, 1, file.getId()));
    ...
    public void whenUpdateThenGetUpdated() {
        ...
        var updatedVacancy = new Vacancy(
                vacancy.getId(), "new title",  creationDate.plusDays(1), "new description",
